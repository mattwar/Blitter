...
/// <summary>
/// The binary layout of pixels in a <see cref="PixelFormat"/>
/// </summary>
public readonly record struct PixelFormatDetails
{
    /// <summary>
    /// The pixel format these details describe.
    /// </summary>
    ...
    /// <summary>
    /// Mask isolating the red channel.
    /// </summary>
    public uint RMask { get; init; }

    /// <summary>
    /// Mask isolating the green channel.
    /// </summary>
    public uint GMask { get; init; }

    /// <summary>
    /// Mask isolating the blue channel.
    /// </summary>
    public uint BMask { get; init; }

    /// <summary>
    /// Mask isolating the alpha channel.
    /// </summary>
    ...
    /// <summary>
    /// Bit shift to extract the red channel.
    /// </summary>
    public byte RShift { get; init; }

    /// <summary>
    /// Bit shift to extract the green channel.
    /// </summary>
    public byte GShift { get; init; }

    /// <summary>
    /// Bit shift to extract the blue channel.
    /// </summary>
    public byte BShift { get; init; }

    /// <summary>
    /// Bit shift to extract the alpha channel.
    /// </summary>
