...
/// </summary>
/// <remarks>
/// Text sprites have no visual or collision shape, so they never
/// participate in hit detection. <see cref="Sprite2D.Tint"/> sets the
/// text color (including alpha for fade-outs). <see cref="Sprite2D.Center"/>
/// is the center point of the rendered string; <see cref="Sprite2D.Scale"/>
/// and <see cref="Sprite2D.Rotation"/> are not currently honored — the
