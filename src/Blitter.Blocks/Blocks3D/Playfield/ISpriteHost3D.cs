...
/// for spawn/despawn calls. Implemented by <see cref="PlayField3D"/> today
/// and by chunk-style containers later, so behaviors can spawn projectiles or
/// remove themselves without knowing which concrete host owns the sprite.
/// </summary>
