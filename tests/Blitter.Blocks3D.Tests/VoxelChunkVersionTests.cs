...
public class VoxelChunkVersionTests
{
    ...
    {
        var world = new SparseVoxelWorld(MakePalette(), new AirGenerator(), 4, 4, 4);
    ...
    public void Source_Edit_BumpsOwningChunk()
    {
        ...
        source.World.SetVoxel(1, 1, 1, 1); // interior of chunk (0,0,0)
    ...
    public void Source_BoundaryEdit_DoesNotBumpDistantChunk()
    {
        ...
        source.World.SetVoxel(3, 1, 1, 1); // chunk 0's boundary, far from chunk 2
