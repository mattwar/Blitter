...
//
//     dotnet run PointLights.cs
//
// While Blitter is unpublished, build a local copy first:
//
//     dotnet build src/Blitter.Package/Blitter.Package.csproj

// Demonstrates Blitter's point-light system. 
// Lights live in a list on the renderer. 
// Lit shaders pick them up automatically through the IUniformArgs trait + 
// a per-frame storage buffer the renderer uploads.
...
// Each light gets a tiny unlit marker cube colored to match.
...
await window.RunAsync(rd =>
{
    ...
    // Three orbiting point lights at different radii, speeds, and bobs.
    // Mutate the renderer's PointLights list freely between frames.
    ...
    using (rd.PushState())
    {
        ...
        // Unlit markers, one per light. 
        // Use PositionColorWithTransform so they show their flat color regardless of lighting.
